...
CC = gcc
FLAG = -w
interpreter: main.o util.o cm.tab.o cm.lex.o symtab.o analyze.o gen.o
	$(CC) $(FLAG) -o ./test/interpreter $(OBJ_DIR)/main.o $(OBJ_DIR)/util.o $(YACC_DIR)/cm.tab.o $(LEX_DIR)/cm.lex.o $(OBJ_DIR)/symtab.o $(OBJ_DIR)/analyze.o $(OBJ_DIR)/gen.o

main.o: $(SRC_DIR)/main.c $(INC_DIR)/parse.h $(INC_DIR)/analyze.h $(INC_DIR)/gen.h
...
gen.o: $(SRC_DIR)/gen.c $(INC_DIR)/globals.h $(INC_DIR)/symtab.h $(INC_DIR)/gen.h
	$(CC) $(FLAG) -c $(SRC_DIR)/gen.c -o $(OBJ_DIR)/gen.o
